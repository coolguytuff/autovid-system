...
def build_visual_query(scene):
    ...
    emotion_map = {
        "fear":
            "dark abandoned scary cinematic",

        "curiosity":
            "mysterious discovery cinematic",

        "shock":
            "dramatic intense cinematic",

        "mystery":
            "unknown cinematic atmosphere",

        "engagement":
            "dark cinematic background",
    }

    emotional_visual = emotion_map.get(
        emotion,
        "cinematic mystery"
    )
